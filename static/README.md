...
```html
<script src='https://unpkg.com/@migenius/realityserver-extras@1.0.5'></script>
```
or unminified
```html
<script src='https://unpkg.com/@migenius/realityserver-extras@1.0.5/lib/umd/realityserver-extras.js'></script> 
```
